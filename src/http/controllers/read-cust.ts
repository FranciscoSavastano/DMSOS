...
import { makeReadCustUseCase } from '@/use-cases/factories/make-read-cust-use-case'
import type { FastifyReply, FastifyRequest } from 'fastify'
import { z } from 'zod'

export async function readCust(request: FastifyRequest, reply: FastifyReply) {
  ...
  try {
    const readUserUseCase = makeReadCustUseCase()
